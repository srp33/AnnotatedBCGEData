...
BiocManager::install("AnnotatedBCGEData", version="devel")
```

Finally, load the package:

```{r load_this_package, eval = FALSE}
...
```{r get_dataset, eval = requireNamespace('AnnotatedBCGEData')}
...
``` {r heatmap_1, message=FALSE, warning=FALSE}
