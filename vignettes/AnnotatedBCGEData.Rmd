...
Here, we first accessed the matrices for 2 more data sets included in AnnotatedBCGEData. 
...
GSE41197_gene = GSE41197_expression_data %>%
    as_tibble(rownames='Ensembl_Gene_ID') %>%
    filter(Ensembl_Gene_ID == "ENSG00000171428") %>%
    pivot_longer(cols=-Ensembl_Gene_ID,
                 names_to='Sample_ID',
